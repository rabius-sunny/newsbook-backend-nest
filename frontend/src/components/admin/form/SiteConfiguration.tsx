...
import {
  SiteSettings,
  siteSettingsSchema,
} from '@/lib/validations/schemas/siteSettingsSchema';
...
const SiteConfiguration = ({ initialValues, refetch }: TProps) => {
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      ...
      const res = await requests[initialValues ? 'patch' : 'post'](
        `/admin/settings${initialValues ? `/key/${key}` : ''}`,
        {
          key,
          value: data,
        },
        ...
        <CardContent>
          <div className="flex flex-wrap gap-4 *:bg-gray-50 *:p-2 *:min-w-24">
            {[
              ...
              {
                label: 'Header BG',
                key: 'header_bg' as const,
                default: '#ffffff',
              },
              {
                label: 'Header Text',
                key: 'header_text' as const,
                default: '#ffffff',
              },
              {
                label: 'Footer BG',
                key: 'footer_bg' as const,
                default: '#ffffff',
              },
              {
                label: 'Footer Text',
                key: 'footer_text' as const,
                default: '#ffffff',
              },
          ...
          <div className="gap-4 grid grid-cols-1">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground text-sm">
                Configure header navigation items
              </p>
