    ...
    return (
      <div className='space-y-4'>
        {value.map((item: any, idx: number) => (
          <div key={idx} className='p-3 border border-gray-300 border-dashed rounded-md'>
            {Object.entries(item)
      ...
      <CardContent>
        ...
        <div className='gap-0 grid text-base'>
          {filteredEntries.map(([key, value]) => (
            <div
              key={key}
              className='flex flex-row flex-wrap md:items-center gap-2 lg:gap-4 py-2.5 border-gray-100 border-b last:border-b-0'
            >
