...
import type { Language, TLanguages } from '../../../../../api-types'
      ...
      <div className='space-y-6'>
        <div className='flex justify-between items-center'>
          <div>
            ...
            <p className='text-muted-foreground'>Manage supported languages for your application</p>
          </div>
      ...
      <div className='gap-4 grid md:grid-cols-3'>
        <Card>
          <CardHeader className='flex flex-row justify-between items-center space-y-0 pb-2'>
            <CardTitle className='font-medium text-sm'>Total Languages</CardTitle>
            <Globe className='w-4 h-4 text-muted-foreground' />
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className='flex flex-row justify-between items-center space-y-0 pb-2'>
            <CardTitle className='font-medium text-sm'>Active Languages</CardTitle>
        ...
        <Card>
          <CardHeader className='flex flex-row justify-between items-center space-y-0 pb-2'>
            <CardTitle className='font-medium text-sm'>Default Language</CardTitle>
            <Badge className='text-xs'>
              {languages.find((lang) => lang.isDefault)?.code.toUpperCase() || 'None'}
            </Badge>
          </CardHeader>
          <CardContent>
            <div className='text-muted-foreground text-sm'>
              {languages.find((lang) => lang.isDefault)?.name || 'No default set'}
            </div>
          </CardContent>
        </Card>
      </div>
